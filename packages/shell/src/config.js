...
export const IPFS_GATEWAY_HOST = process.env.IPFS_GATEWAY_HOST || "http://gateway.ipfs.io:5001"
export const SIGNUP_WALLET_ENTRY_HOST = process.env.SIGNUP_WALLET_ENTRY_HOST
export const SIGNUP_WALLET_ENTRY_PATH = process.env.SIGNUP_WALLET_ENTRY_PATH.replace(/^\//, '') || "js/signupCoreEntry.js"
