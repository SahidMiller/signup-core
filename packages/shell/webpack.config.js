...
module.exports = merge({
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
        ...
        exposes: {
          "./Article": path.join(__dirname, "./src/components/common/Article.js"),
          "./Box": path.join(__dirname, "./src/components/common/Box.js"),
          "./Button": path.join(__dirname, "./src/components/common/Button.js"),
          "./Checkbox": path.join(__dirname, "./src/components/common/Checkbox.js"),
          "./Heading": path.join(__dirname, "./src/components/common/Heading.js"),
          "./Input": path.join(__dirname, "./src/components/common/Input.js"),
          "./Loading": path.join(__dirname, "./src/components/common/Loading.js"),
          "./Logo": path.join(__dirname, "./src/components/common/Logo.js"),
          "./ReloadButton": path.join(__dirname, "./src/components/common/ReloadButton.js"),
          "./Tabs": path.join(__dirname, "./src/components/common/Tabs.js"),
          "./TextArea": path.join(__dirname, "./src/components/common/TextArea.js"),
          "./RecoveryPhrases": path.join(__dirname, "./src/components/common/RecoveryPhrases.js"),
          "./ConfirmRecoverPhrases": path.join(__dirname, "./src/components/common/ConfirmRecoveryPhrases.js"),
